...
QT_MOC_LITERAL(1, 10, 11), // "cursorMoved"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "time"
QT_MOC_LITERAL(4, 28, 3), // "idx"
QT_MOC_LITERAL(5, 32, 20), // "QMap<QString,double>"
QT_MOC_LITERAL(6, 53, 6), // "errors"
QT_MOC_LITERAL(7, 60, 11), // "fileDropped"
QT_MOC_LITERAL(8, 72, 8) // "filePath"

    },
    "ChartView\0cursorMoved\0\0time\0idx\0"
    "QMap<QString,double>\0errors\0fileDropped\0"
    "filePath"
};
...
void ChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cursorMoved((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< const QMap<QString,double>(*)>(_a[3]))); break;
        case 1: _t->fileDropped((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ChartView::*)(double , int , const QMap<QString,double> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartView::cursorMoved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartView::fileDropped)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChartView::cursorMoved(double _t1, int _t2, const QMap<QString,double> & _t3)
{
...
// SIGNAL 1
void ChartView::fileDropped(const QString & _t1)
{
